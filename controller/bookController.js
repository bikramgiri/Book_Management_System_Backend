...
exports.addBook = async (req, res) => {
      const { bookName, bookPrice, autherName, isbnNumber, publication, publishedAt } = req.body;
      if (!bookName || !bookPrice || !autherName || !isbnNumber || !publication || !publishedAt) {
            return res.status(400).json({ 
                  message: "bookName, bookPrice, autherName, isbnNumber, publication and publishedAt are required" 
            });
      }
